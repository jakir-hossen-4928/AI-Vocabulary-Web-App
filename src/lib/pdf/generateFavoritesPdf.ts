...
export const generateFavoritesPDF = async ({ vocabularies, userName, userEmail }: GeneratePdfOptions) => {
    try {
        ...
        // Enhanced PDF content with better layout
      ...
      <div class="report-container">
        ...
        <div class="report-info">
          <div class="user-details">
            ...
            <p><strong>Export Date:</strong> ${format(new Date(), "PPP")}</p>
            <p><strong>Total Words:</strong> ${vocabularies.length}</p>
          </div>
        </div>
          ...
          ${vocabularies.map((vocab, index) => `
            <div class="vocab-item">
              ...
              <div class="vocab-body">
                <p class="vocab-meaning"><strong>Meaning:</strong> ${vocab.bangla}</p>
                <p class="vocab-pronunciation"><strong>Pronunciation:</strong> ${vocab.pronunciation}</p>
                ${vocab.example ? `<p class="vocab-example"><strong>Example:</strong> "${vocab.example}"</p>` : ''}
              </div>
            </div>
          `).join('')}
        </div>
        ...
        <div class="footer">
          ...
          <p class="generated-at">Report created on ${new Date().toLocaleString()}</p>
        </div>
      </div>
    `;
